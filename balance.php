   ...
   <head>
	...
	<body style="background:#4d0039" >
	   ...
	   <section id="section1">
			...
			<div class="title" style="color:#4d0039; background:#99ffff; text-align:center; margin-left:30%; margin-right:30%; margin-top:20px; margin-bottom:20px"> Want to check your balance?</div>
			
			<form action="checkbalance.php" class="form_design" method="post" style="color:#4d0039; background:#99ffff; margin-left:30%; margin-right:30%;">
			      Enter your Id </br> </br> <input type="text" name="id"  style="background:#ffffff"> <br/> </br>
				  <input type="submit" value="check" style="color:#99ffff; background:#4d0039; margin-top:20px">
				  </form>
