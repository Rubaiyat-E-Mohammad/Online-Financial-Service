   ...
   <head>
	...
	<body style="background:#4d0039" >
	   ...
	   <section id="section1">
			...
			<div class="title" style="color:#4d0039; background:#99ffff; text-align:center; margin-left:30%; margin-right:30%; margin-top:20px; margin-bottom:20px"> Want to send money to other user?</div>
			
			<form action="money.php" class="form_design" method="post" style="color:#4d0039; background:#99ffff; margin-left:30%; margin-right:30%;">
			      Enter User ID </br> </br> <input type="text" name="id1"  style="background:#ffffff"> <br/> </br>
				  Enter Account No </br> </br> <input type="text" name="id2"  style="background:#ffffff"> <br/> </br>
				  Enter Amount </br> </br> <input type="text" name="amount"  style="background:#ffffff"> <br/> </br>
				  <input type="submit" value="Send" style="color:#99ffff; background:#4d0039; margin-top:20px">
				  </form>
