   ...
   <head>
	...
	<body style="background:#4d0039" >
	   ...
	   <section id="section1">
			...
			<div class="title" style="color:#4d0039; background:#99ffff; text-align:center; margin-left:30%; margin-right:30%; margin-top:20px; margin-bottom:20px"> Want to cash out from your account?</div>
			
			<form action="out.php" class="form_design" method="post" style="color:#4d0039; background:#99ffff; margin-left:30%; margin-right:30%;">
			      Enter User ID </br> </br> <input type="text" name="id1"  style="background:#ffffff"> <br/> </br>
				  Enter Agent ID </br> </br> <input type="text" name="id2"  style="background:#ffffff"> <br/> </br>
				  Enter Account No </br> </br> <input type="text" name="id3"  style="background:#ffffff"> <br/> </br>
				  Date (YYYY-MM-DD) </br> </br> <input type="date_default_timezone_set" name="id4"  style="background:#ffffff"> <br/> </br>
				  Time (HH:MM:DD) </br> </br> <input type="timezone_version_get" name="id5"  style="background:#ffffff"> <br/> </br>
				  Enter Amount </br> </br> <input type="text" name="amount"  style="background:#ffffff"> <br/> </br>
				  <input type="submit" value="Cash out" style="color:#99ffff; background:#4d0039; margin-top:20px">
				  </form>
